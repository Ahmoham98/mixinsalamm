        ...
        >
          ...
          <nav className="space-y-2 flex-1">
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-4 py-3 text-gray-700 bg-[#5b9fdb]/10 rounded-lg transition-colors"
            >
              <Link2 size={20} />
            ...
            <div className="flex items-center justify-between">
              <div className="text-center flex-1">
                ...
                <p className="text-gray-600">
                  در صورت بروز هرگونه سوال یا مشکل با ما در تماس باشید
                </p>
              </div>
            </div>
          </div>
        ...
        <main className="max-w-7xl mx-auto px-8 py-8" dir="rtl">
          ...
          <div className="max-w-5xl mx-auto">
            <p className="text-gray-700 leading-7 mb-6">
              تا زمان آماده‌شدن سامانه تیکتینگ، می‌توانید از راه‌های زیر با
              پشتیبانی در تماس باشید. ما در سریع‌ترین زمان ممکن پاسخگو خواهیم
              بود.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-white rounded-lg shadow border border-gray-100">
                ...
                <p className="text-gray-700 mb-3">
                  در ساعات اداری می‌توانید با شماره زیر تماس بگیرید:
                </p>
                <a
                  href="tel:09962278508"
              ...
              <div className="p-4 bg-white rounded-lg shadow border border-gray-100">
                ...
                <p className="text-gray-700 mb-3">
                  در هر زمان برای ما ایمیل ارسال کنید:
                </p>
                <a
                  href="mailto:electricallover45@gmail.com"
                  className="inline-block px-4 py-2 rounded-md bg-emerald-600 text-white hover:bg-emerald-700 transition-colors break-all"
                >
            ...
            <div className="mt-8 p-4 bg-white rounded-lg shadow border border-gray-100">
              ...
              <ul className="list-disc pr-6 text-gray-700 space-y-2">
                ...
                <li>
                  نام کاربری یا ایمیل ورود خود را برای پیگیری سریع‌تر درج کنید.
                </li>
              </ul>
            </div>
          </div>
