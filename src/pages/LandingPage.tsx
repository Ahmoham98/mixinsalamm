...
function LandingPage() {
  // Changed function name from App to LandingPage
  ...
  const handleScroll = () => {
    ...
    if (window.scrollY > 100) {
      ...
      // At the very top of the page (or within 100px), always show header
      setShowHeader(true);
    }
  ...
  return (
    ...
    <div
      dir="rtl"
      className="min-h-screen bg-white text-gray-800 flex flex-col items-center p-4 sm:p-6 lg:p-8"
    ...
    >
      ...
      <header
        className={`w-full flex flex-col sm:flex-row justify-between items-center py-3 px-6 bg-gray-100 fixed top-0 z-50 transition-transform duration-300 ease-out ${showHeader ? "translate-y-0 shadow-md" : "-translate-y-full"}`}
      >
        <h1
          className="text-3xl sm:text-4xl font-bold text-blue-600 order-2 sm:order-1"
        ...
        <nav className="flex space-x-2 sm:space-x-3 rtl:space-x-reverse order-1 sm:order-2">
          ...
          <a
            href="#contact-us"
            className="px-4 py-2 bg-blue-500 text-white text-sm font-semibold rounded-lg shadow-md hover:bg-blue-600 transition duration-300 ease-in-out transform hover:scale-105 w-28 text-center flex items-center justify-center"
          >
            تماس با ما
          </a>
        </nav>
      ...
      <main className="w-full max-w-6xl flex flex-col lg:flex-row items-center gap-2 bg-white p-6 sm:p-8 mt-[80px]">
        {" "}
        {/* Added mt-[80px] */}
        ...
        <section className="w-full lg:w-1/2 text-right p-4 order-1 border border-gray-100 rounded-lg shadow-sm">
          ...
          <p className="text-lg leading-relaxed text-gray-700 mb-6">
            ...
            <br />
            دیگر نگران مدیریت محصولات خود در میکسین و باسلام نباشید. با پلتفرم
            ما، همه چیز در یک نگاه!
            <a
              href="#goals"
              className="text-blue-500 hover:text-blue-700 font-bold mr-2 transition duration-300 ease-in-out"
            >
              ...
            </a>
          </p>
      ...
      <section
        id="goals"
        className="w-full max-w-6xl bg-white p-6 sm:p-8 mt-2 text-right"
      >
        {/* Changed text-gray-900 to text-blue-900 for navy blue color */}
        <h2 className="text-3xl font-bold text-blue-900 mb-4">اهداف سایت ما</h2>
        <ul className="list-disc pr-6 text-lg leading-relaxed text-gray-700 space-y-4">
          <li>
            <span className="font-semibold text-blue-700">
              یکپارچه‌سازی کامل فروشگاه‌ها
            </span>
            <br />
            همه محصولاتت در یک‌جا
            <br />
            بدون نیاز به رفتن به میکسین یا باسلام، همه محصولاتت رو یکجا ببین و
            مدیریت کن.
          </li>
          <li>
            <span className="font-semibold text-blue-700">
              مدیریت هوشمند محصولات
            </span>
            <br />
            بدون محصول تکراری، بدون سردرگمی
            <br />
            می‌فهمی کدوم محصول فقط توی یک سایت هست و با یه کلیک اون رو به سایت
            دیگه اضافه می‌کنی.
          </li>
          <li>
            <span className="font-semibold text-blue-700">
              تغییر بده، هم‌زمان بروزرسانی شو
            </span>
            <br />
            هر ویرایشی که بزنی (قیمت، عکس، توضیح...) فوراً توی هر دو سایت اعمال
            می‌شه.
          </li>
          <li>
            <span className="font-semibold text-blue-700">
              کاهش خطا و افزایش سرعت
            </span>
            <br />
            وقت کمتر برای مدیریت، تمرکز بیشتر برای فروش
            <br />
            با حذف کارهای تکراری و ورود داده تکراری، همه‌چیز سریع‌تر و بدون خطا
            پیش می‌ره.
          </li>
          <li>
            <span className="font-semibold text-blue-700">
              تجربه‌ای راحت برای همه
            </span>
            <br />
            رابط ساده، کارایی بالا
            <br />
            طراحی شده برای اینکه حتی بدون دانش فنی هم بتونی راحت باهاش کار کنی و
            ازش لذت ببری.
          </li>
        </ul>
      </section>
      ...
      <footer className="w-full flex flex-col sm:flex-row justify-between items-start gap-8 bg-white p-6 sm:p-8 mt-8 text-gray-800 border-t border-gray-200">
        <div className="flex-1 text-right">
          ...
          <p className="text-md leading-relaxed text-gray-700">
            پلتفرم mixinsalam با هدف ساده‌سازی مدیریت فروش برای کسب‌وکارهای
            آنلاین طراحی شده است. ما به شما کمک می‌کنیم تا با یکپارچه‌سازی
            فروشگاه‌های خود در میکسین و باسلام، زمان و انرژی بیشتری برای توسعه
