...
function CredentialsPage() {
  ...
  const handleBasalamConnect = () => {
    ...
    const basalamUrl = 'https://basalam.com/accounts/sso?client_id=1227&scope=vendor.profile.read%20vendor.product.write%20customer.profile.read%20vendor.product.read&redirect_uri=https://mixinsalam.onrender.com/basalam/client/get-user-access-token/&state=test-bardia-onrender';
