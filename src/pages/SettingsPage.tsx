          ...
          <div className="max-w-7xl mx-auto px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <div className="text-center flex-1">
                ...
                <p className="text-gray-600 mt-1">مدیریت تنظیمات حساب کاربری شما</p>
              </div>
        ...
        <main className="max-w-4xl mx-auto px-8 py-8">
          <div className="bg-white/80 backdrop-blur-md rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="p-6 border-b border-gray-100">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-gray-800">همگام‌سازی خودکار</h2>
                  <p className="text-sm text-gray-600">تنظیمات مربوط به به‌روزرسانی خودکار محصولات</p>
                </div>
              </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-2">
                      <h3 className="font-semibold text-gray-800">فعال‌سازی همگام‌سازی خودکار</h3>
                    ...
                    <p className="text-sm text-gray-700 mb-3" dir="rtl">
                      با فعال کردن این گزینه، هر زمان که محصولی در میکسین تغییر کند و نیاز به همگام‌سازی با باسلام داشته باشد، 
                      سیستم به طور خودکار تغییرات را اعمال خواهد کرد. این باعث می‌شود که شما نیازی به کلیک دستی روی دکمه همگام‌سازی نداشته باشید.
                    </p>
            ...
            <div className="p-6 bg-gray-50">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  {saveMessage && (
                    <div className={`flex items-center gap-2 text-sm ${saveMessage.isSuccess ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div className="mt-8 bg-white/60 backdrop-blur-md rounded-xl shadow-lg border border-gray-100 p-6">
            <div className="text-center text-gray-500">
              ...
              <h3 className="text-lg font-medium mb-2">بخش‌های بیشتر در آینده</h3>
              <p className="text-sm">بخش‌های تنظیمات بیشتری در نسخه‌های آتی اضافه خواهد شد.</p>
            </div>
          </div>
        </main>
      </div>
