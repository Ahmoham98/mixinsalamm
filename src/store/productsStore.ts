...
export const useProductsStore = create<ProductsState>((set) => ({
  ...
  lastUpdated: null,
  setUniqueLists: (mixin, basalam) => set({ uniqueMixinProducts: mixin, uniqueBasalamProducts: basalam, lastUpdated: Date.now() }),
  clear: () => set({ uniqueMixinProducts: [], uniqueBasalamProducts: [], lastUpdated: null }),
}))
